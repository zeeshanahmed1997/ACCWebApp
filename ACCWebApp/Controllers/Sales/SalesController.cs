...
namespace ACCWebApp.Controllers
{
    public class SalesController : Controller
    {
        ...
        public async Task<ActionResult> Create(SalesViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    {
                        var response = await httpClient.PostAsJsonAsync("https://localhost:7240/api/sales", sale);
        ...
        public async Task<List<Clothing>> FetchClothings()
        {
            ...
            var response = await httpClient.GetAsync("https://localhost:7240/api/clothes");
        ...
        {
            var httpClient = _httpClientFactory.CreateClient();
            var response = await httpClient.GetAsync("https://localhost:7240/api/Gender");
